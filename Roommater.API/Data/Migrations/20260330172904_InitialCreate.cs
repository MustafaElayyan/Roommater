        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HouseholdTasks_Users_AssignedToUserId",
                        column: x => x.AssignedToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_HouseholdTasks_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseholdTasks_AssignedToUserId",
                table: "HouseholdTasks",
                column: "AssignedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseholdTasks_CreatedByUserId",
                table: "HouseholdTasks",
                column: "CreatedByUserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_GroceryItems_Households_HouseholdId",
                table: "GroceryItems",
                column: "HouseholdId",
                principalTable: "Households",
                principalColumn: "Id",
